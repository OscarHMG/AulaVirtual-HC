...
<div class="wrap">
	...
	<form method="post" action="" enctype="multipart/form-data">
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><label for="users_role"><?php _e( 'Rol', 'users-data-to-csv' ); ?></label></th>
				<td>
					<select name="role" id="users_role">
						<?php
						echo '<option value="">' . __( 'Todos', 'users-data-to-csv' ) . '</option>';
						global $wp_roles;
			...
			<tr valign="top">
				<th scope="row"><label><?php _e( 'Rango de d&iacute;as', 'users-data-to-csv' ); ?></label></th>
				<td>
			...
			<tr valign="top">
				<th scope="row"><label><?php _e( 'Curso de Capacitaci&oacute;n', 'users-data-to-csv' ); ?></label></th>
				<td>
					<select name="cursos" id="users_cursos">
						<?php
							global $wpcwdb, $wpdb;
							$wpdb->show_errors();
							...
							if ($courses)  
							{
								...
								{
									echo "\n\t<option value='" . esc_attr( $course->course_id ) . "'>$course->course_title</option>";
								}
		...
		<p class="submit">
			...
			<input type="submit" class="button-primary" value="<?php _e( 'Exportar ussuario', 'users-data-to-csv' ); ?>" />
		</p>
	</form>
<?php
	}
