...
class WP_User_Avatar_Admin {
  ...
  public function wpua_add_default_avatar() {
    ...
    $wpua_list .= '<p id="wpua-edit"><button type="button" class="button" id="wpua-add" name="wpua-add" data-avatar_default="true" data-title="'._('Escoger Imagen').': '._('Avatar por defecto:').'">'.__('Escoger Imagen','wp-user-avatar').'</button>';
    $wpua_list .= '<span id="wpua-remove-button"'.$hide_remove.'><a href="#" id="wpua-remove">'.__('Quitar','wp-user-avatar').'</a></span><span id="wpua-undo-button"><a href="#" id="wpua-undo">'.__('Deshacer','wp-user-avatar').'</a></span></p>';
