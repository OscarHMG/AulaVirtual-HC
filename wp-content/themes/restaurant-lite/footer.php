    	...
    	<div class="container">
             ...
             <div class="cols-4 widget-column-2">            	
               <h5><?php echo get_theme_mod('about_title',__('Our Philosophy','restaurant')); ?></h5>            	
				<p><?php echo get_theme_mod('about_description',__('Consectetur, adipisci velit, sed quiaony on numquam eius modi tempora incidunt, ut laboret dolore agnam aliquam quaeratine voluptatem1. ut enim ad minima veniamting suscipit lab','restaurant')); ?></p>            	
              </div>     
               ...
               <div class="cols-4 widget-column-3">
                  ...
                  <div class="social-icons">
                    ...
                    <?php } else { ?>
                    <?php echo '<a href="https://www.instagram.com/hogardecristoec/" target="_blank" class="in" title="linkedin"></a>'; } ?>
                  </div>   
                </div>
              ...
              <div class="phone-no"><?php echo get_theme_mod('contact_no',__('<strong>Phone:</strong> +593 4 390 4449 Ext. 101','restaurant')); ?> <br  />
